...
<div class="collapse-area rounded-md mb-8">
  <input type="checkbox" name="my-accordion-2" /> 
  <div class="collapse-title text-xl font-medium">
    <h3>Original Positioning Statement</h3>
  </div>
...
- [World Building with Keiken](/projects/residency-event-keiken/)
- [World Building Houdini Workshop](/projects/residency-event-world-building-houdini/)
- [ChatBot with Rivescript Workshop](/projects/residency-event-chatbot-rivescript/)
- [Eccentric Engineering with Tega Brain](/projects/residency-event-tega-brain/)
- [Investigative Journalism with Bellingcat](/projects/residency-event-bellingcat/)
- [Maggie Roberts / orphan drift](/projects/residency-event-maggie-roberts/)
- [In-Wellness™ with Jake Charles Rees](/projects/residency-event-in-wellness/)


We organised events and collaborative making sessions under these themes:

<div class="collapse-area rounded-md">
  <input type="radio" name="theme-accordion" /> 
  <div class="collapse-title text-xl font-medium">
    <h3>Remote Locale</h3>
  </div>
  <div class="collapse-content"> 
